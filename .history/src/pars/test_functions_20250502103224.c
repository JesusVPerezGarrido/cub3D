...
/*   Updated: 2025/05/02 10:32:24 by auloth           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_map(t_map* map)
{
	...
	ft_printf("player position x: %i\n", map->player.pos.x);
	ft_printf("player position y: %is\n", map->player.pos.y);
	ft_printf("player direction x: %i\n", map->player.dir.x);
	ft_printf("player direction y: %i\n", map->player.dir.y);
