...
/*   Updated: 2025/05/02 10:09:52 by auloth           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if(c == 'N')
		return(map->player.pos = set_vector(x, y), map->player.dir );
	if(c == 'S')
		return(0);
	if(c == 'E')
		return(0);
...
int	find_player(t_map *map)
{
	...
	while (map->map[y])
	{
		...
		{
			if (valid_player_pos())
				return(map->player.pos = set_vector(x, y), map->player.dir = set_vector())
		}
	}
}
